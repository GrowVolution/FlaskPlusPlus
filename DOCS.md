...
to use the vite files of your modules.
...
Flask++ provides a native integration of Tailwind CSS and Node.js. To use Tailwind, simply integrate:
...
into your base template and work with its CSS utility. The app will (re-)generate the tailwind.css file when
it is created.
