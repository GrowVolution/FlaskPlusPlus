...
And you can also work with Tailwind (Notice that we are using the <a href="#externals">standalone Tailwind integration</a> to generate your CSS.
...
And if you'd like to work with the native standalone node bundle, you can use the Flask++ Node CLI:

```bash
fpp node [npm/npx] [args]
```

Of course, you can use the Tailwind CLI similarly:
